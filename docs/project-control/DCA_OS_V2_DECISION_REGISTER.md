...
| V2-015 (P2-A) | Owner prepares the snapshot outside Codex as an anonymized offline file. | DECIDED | Codex only validates/consumes an owner-provided file and never connects to a database for P2-A. |
