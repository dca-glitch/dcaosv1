...
> **LIVE GA4/GSC WITHDRAWN (2026-07-13):** Live GA4/GSC integrations are **withdrawn** from current and planned scope. Not a Puriva Launch blocker. Google Drive remains separate. Historical "next = GA/GSC" references below are superseded.
...
| 7 | VPS staging | Live proofs: Email → AI → R2 → Image → WordPress → MI (GA4/GSC **WITHDRAWN**) |
