...
| 1 | Identity, tenancy, and Workspace foundation | IN_PROGRESS (P1.1–P1.3a complete; P1.4a next) | 20% |
...
P1.1–P1.3a preparation is complete. P1.3a adds deterministic comparison, OFF-only flags, isolation proof, and rollback planning without reconciliation execution or authority switch. The next eligible package is **P1.4a preparation only**. Tenant/Client remains authoritative.
