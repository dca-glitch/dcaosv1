...
| R-022 | Build/runtime parity not validated on VPS | Deployment | Partial | Dockerfile and Compose files exist; local build passes | No VPS Docker Compose run evidence yet | Staging drift | High | Dry-run approved Docker Compose services on VPS | Engineering/Ops | P1 | Yes | Yes |
