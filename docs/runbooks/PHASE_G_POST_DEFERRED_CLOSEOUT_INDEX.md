...
|-------|---------|------------|--------|
| G1 | [`PHASE_G_BLOCK_1_STAGING_TARGET_AND_VPS_PACK.md`](./PHASE_G_BLOCK_1_STAGING_TARGET_AND_VPS_PACK.md) | `staging-target-decision-template.md` (archived reference; see Git history) completed | No/docs closed |
...
- [x] Staging target decision template completed — `staging.digitalcubeagency.net` (see `staging-target-decision-template.md` (archived reference; see Git history)).
