...
- Monthly Report Market Intelligence context implemented: admin-only monthly reports can reference applied MI handoffs through internal context fields and admin UI; validation passed; focused smoke remains deferred after Cline smoke-generation instability.
