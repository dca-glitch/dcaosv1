...
- **Block 6C-v1 (planned)** — admin read-only visibility UI for safe `knowledgeContext` metadata on Workflow Briefs screens (MI/SEO run, production plan, content drafts); not client-visible.
