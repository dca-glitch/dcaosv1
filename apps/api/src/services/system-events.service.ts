...
export type AiDeliverySystemEventName =
  ...
  | "AI_DELIVERY_CONTENT_PLAN_CREATED"
  | "AI_DELIVERY_CONTENT_PLAN_UPDATED"
  | "AI_DELIVERY_CONTENT_PLAN_REVIEW_REQUESTED"
  | "AI_DELIVERY_CONTENT_PLAN_APPROVED"
  | "AI_DELIVERY_CONTENT_PLAN_CHANGES_REQUESTED"
  | "AI_DELIVERY_CONTENT_DRAFT_CREATED"
  | "AI_DELIVERY_CONTENT_DRAFT_UPDATED"
  | "AI_DELIVERY_CONTENT_DRAFT_REVIEW_REQUESTED"
  | "AI_DELIVERY_CONTENT_DRAFT_RETURNED_TO_DRAFT"
  | "AI_DELIVERY_CONTENT_DRAFT_CLIENT_APPROVED"
  | "AI_DELIVERY_CONTENT_DRAFT_CLIENT_CHANGES_REQUESTED"
  | "AI_DELIVERY_ARTICLE_IMAGE_CREATED"
  | "AI_DELIVERY_ARTICLE_IMAGE_UPDATED"
  ...
  | "MI_SUMMARY_APPLIED_TO_DELIVERY"
  | "MI_SUMMARY_APPLIED_TO_BRIEF"
  | "MI_SUMMARY_APPLIED_TO_SEO_CONTEXT"
  | "AI_DELIVERY_DELIVERABLE_CREATED"
  | "AI_DELIVERY_DELIVERABLE_UPDATED"
  | "AI_DELIVERY_DELIVERABLE_READY"
  | "AI_DELIVERY_DELIVERABLE_REVISION_REQUESTED"
  | "AI_DELIVERY_DELIVERABLE_ACCEPTED"
  | "AI_DELIVERY_DELIVERABLE_ARCHIVED"
  | "AI_DELIVERY_DELIVERABLE_RESTORED"
